...
- Languages: Python, Go, Rust, Bash, Haskell (check out my [interpreter](https://github.com/santiago-mooser/haskell-based-interpreter)!)
- Platforms: Kubernetes, ArgoCD, Docker, Ansible, Terraform/Terragrunt, GitLab CI/CD, GitHub Actions
- Cloud: AWS, GCP
...
- Unix troubleshooting (I run Arch Linux & NixOS at home. Yes, I also ask myself why every time I break my install :) )

My full CV is on [santiago-mooser.com](https://santiago-mooser.com) ([PDF](https://santiago-mooser.com/cv.pdf)).
